...
This is proved by letting \gamma equal the ![](cs229-notes4.fld/image020.png) term，using our previous argument that uniform convergence occurs with probability at least 1 - δ, and then noting that uniform convergence implies ε(h) is at most 2\gamma higher than ε(h∗) = minh∈H ε(h) (as we showed previously).
